...
extrafont::font_import("./IBM-Plex-Sans")
...
ggplot(states %>% filter(state == "SC") %>%
  ...
  scale_x_continuous(breaks = two_weeks, labels = into_date) +
  ggtitle("Cases and Testing") -> tests
...
smooth2 <- paste0(
  ...
  "Rolling average number of positives: ", round(10^gtests$x$data[[2]]$y)
)
